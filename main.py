...
try:
    ...
    st.error("Error: File 'amazon_cleaned_with_sentiment.csv' not found. Please upload the file to GitHub.")
    st.stop()
...
st.sidebar.subheader("🧪 Test New Sentiment")
user_input = st.sidebar.text_area("Enter customer review here:")
...
st.write("This project uses **Natural Language Processing (NLP)** to analyze customer emotions regarding Amazon products.")
...
with col_left:
    ...
    # Note: Using the original column categories 'Positif', 'Negatif', 'Neutral' from your CSV logic
...
with col_right:
    ...
    target_sentiment = st.selectbox("Select Sentiment:", ["Positif", "Negatif"])
...
st.write("Below are the first 50 rows of the processed data:")
